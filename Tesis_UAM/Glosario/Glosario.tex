...
\newglossaryentry{bolsadepalabras}{
	...
	description={Modelo de representación de texto que describe la ocurrencia de palabras en un documento, ignorando el orden y la estructura gramatical. Cada documento se representa como un vector donde cada dimensión corresponde a una palabra del vocabulario y su valor indica la frecuencia de aparición de esa palabra. Es fundamental para técnicas como TF-IDF y constituye la base para muchos algoritmos de clasificación de texto tradicionales.}
}
