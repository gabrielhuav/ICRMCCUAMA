...
Se priorizaron publicaciones de los últimos cinco años (2020-2025), sin excluir trabajos fundamentales anteriores. Los criterios de inclusión fueron: contribuciones metodológicas originales, validación empírica, relevancia directa para la detección de desinformación y calidad de la revisión por pares. Como resultado, se identificaron 80 trabajos que constituyen el núcleo de esta revisión.
...
\begin{enumerate}
    ...
    \item \textbf{La era contemporánea (2021-presente)}, dominada por modelos de lenguaje a gran escala y enfoques híbridos.
\end{enumerate}
...
La necesidad de modelos más eficientes llevó al desarrollo de variantes como \textbf{DistilBERT} \cite{sanh2019distilbert}, que mantiene el 97% del rendimiento de BERT con solo el 60% de sus parámetros. En el contexto del español, Martínez-Gallego et al. \cite{martinez2021fake} demostraron que los modelos preentrenados específicamente en este idioma, como \textbf{BETO}, superan a las versiones multilingües genéricas.

El surgimiento de modelos generativos a gran escala como \textbf{GPT-3} \cite{brown2020language} ha introducido nuevas complejidades, ya que pueden crear contenido sintético indistinguible del humano. Investigaciones recientes revelan que los detectores actuales muestran sesgos contra el texto generado por LLMs \cite{su2023fake}, lo que plantea cuestiones sobre la generalización y equidad de estos sistemas.
