...
\hline
\begin{tabular}[t]{@{}l@{}}Marco metodológico para construcción\\de datasets de noticias en español\end{tabular} & Acosta, F. A. Z. & U. Politécnica de Madrid & 2019 & \cite{acosta2019construccion} \\
\hline
...
Imagina que estás desarrollando y entrenando un modelo de machine learning, que podemos conceptualizar como el proceso complejo de crear un pastel sofisticado con múltiples capas y componentes interconectados.
