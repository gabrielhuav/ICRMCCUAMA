...
Se priorizaron publicaciones de los últimos cinco años (2020-2025), sin excluir trabajos fundamentales anteriores. Los criterios de inclusión fueron: contribuciones metodológicas originales, validación empírica robusta, relevancia directa para la detección de desinformación y calidad de la revisión por pares. Como resultado, se identificaron 86 trabajos que constituyen el núcleo de esta revisión, representando una cobertura comprehensiva del estado actual del conocimiento en el campo.
...
El presente trabajo de investigación se posiciona de manera distintiva frente a los estudios analizados mediante varias contribuciones particulares. Mientras que trabajos previos como los de Acosta \cite{acosta2019construccion} y Posadas-Durán et al. \cite{posadas2019detection} establecieron corpus pioneros para español con cientos o miles de muestras, esta investigación construye un corpus unificado a gran escala de más de 61,000 registros balanceados, integrando cuatro fuentes académicas reconocidas y enriqueciéndolo mediante extracción web verificada, constituyendo uno de los recursos más extensos disponibles para español. A diferencia de aproximaciones que se centran exclusivamente en modelos de lenguaje como Blanco-Fernández et al. \cite{blanco2024enhancing} o únicamente en optimización metaheurística como Aqil y Lahby \cite{aqil2021modeling}, este trabajo implementa una metodología evolutiva dual que establece primero una línea base robusta mediante cinco algoritmos metaheurísticos diferentes (MSA, SS, GA, VNS, PSO) optimizando modelos clásicos con representación TF-IDF, y posteriormente desarrolla un sistema avanzado mediante ajuste fino de DistilBERT con técnicas anti-sobreajuste, permitiendo una comparación empírica directa entre paradigmas bajo condiciones experimentales idénticas. Mientras que estudios internacionales alcanzan exactitudes del 90-98\% en inglés, esta investigación logra 95.2\% de exactitud específicamente para español con un modelo DistilBERT optimizado que supera por más de 24 puntos porcentuales al mejor enfoque metaheurístico, demostrando la superioridad de Transformers para esta tarea en el contexto hispanohablante. Más allá de la validación experimental, este trabajo materializa sus resultados en prototipos funcionales contenerizados con Docker listos para despliegue real, cerrando la brecha entre investigación académica y aplicabilidad práctica. Finalmente, a diferencia de trabajos que se limitan a un dominio específico, la metodología desarrollada demuestra transferibilidad a otros tipos de fraude digital como ofertas de empleo fraudulentas y phishing, estableciendo un marco generalizable más allá de la detección de noticias falsas. Estas particularidades posicionan esta investigación como una contribución integral que no solo alcanza resultados de estado del arte, sino que proporciona recursos, metodologías y herramientas concretas para el ecosistema hispanohablante de lucha contra la desinformación.