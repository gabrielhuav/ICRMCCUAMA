...
\subsubsection{Análisis de Complementariedad entre Corpus}

La selección y combinación de estos cinco fuentes de datos no fue arbitraria, sino que responde a una estrategia metodológica que busca aprovechar las fortalezas complementarias de cada corpus para crear un conjunto de datos robusto y diverso:
