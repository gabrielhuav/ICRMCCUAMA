...
\subsection{Esquema visual del flujo de trabajo general del sistema}
...
\begin{itemize}
    \item \textbf{Capa de datos:} Proceso de unificación del corpus desde múltiples fuentes académicas y extracción web
    \item \textbf{Capa de preprocesamiento:} Flujo de procesamiento de datos común para limpieza, tokenización y representación textual
    \item \textbf{Capa de modelado dual:} Implementación paralela de enfoques metaheurísticos y Transformer
    \item \textbf{Capa de evaluación:} Marco unificado de métricas y validación cruzada
    \item \textbf{Capa de aplicación:} Integración del modelo óptimo en sistema productivo
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Clase 1 (REAL):} Incluye contenido periodístico legítimo, noticias verificadas de fuentes confiables e información factualmente correcta
\end{itemize}
...
Para garantizar una comprensión completa de las características y diferencias entre los corpus utilizados, se presenta un análisis comparativo exhaustivo que permite entender las fortalezas y limitaciones de cada fuente de datos, así como las decisiones metodológicas tomadas en el proceso de unificación (ver Tabla \ref{tab:comparacion_exhaustiva_corpus}).
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Fuente de Datos}} & \textbf{\textcolor{white}{Noticias}} & \textbf{\textcolor{white}{Porcentaje}} & \textbf{\textcolor{white}{Tipo}} & \textbf{\textcolor{white}{Estado}} \\
\hline
\rowcolor{UAMAzcapoLight!40}
...
\subsubsection{Concepto e importancia del balanceo de clases}
...
\begin{itemize}
    \item \textbf{Conjunto de entrenamiento suficiente:} 70\% proporciona datos abundantes para el aprendizaje de patrones complejos
    \item \textbf{Validación efectiva:} 10\% permite calibración de hiperparámetros sin comprometer datos de prueba
    \item \textbf{Evaluación objetiva:} 20\% reservado exclusivamente para pruebas finales sin contaminar el proceso de desarrollo
\end{itemize}
...
\textbf{Gestión de sesgo en el dataset:}

Para minimizar posibles sesgos en el conjunto de datos, se implementaron las siguientes medidas:

\begin{enumerate}
    \item \textbf{Estratificación rigurosa:} Uso de \texttt{train\_test\_split} con parámetro \texttt{stratify} para mantener distribución de clases en cada partición
    \item \textbf{Aleatorización controlada:} Semilla fija (\texttt{random\_state=42}) para reproducibilidad sin pérdida de aleatoriedad
    \item \textbf{Análisis de distribución:} Verificación estadística de la distribución de clases en cada subconjunto mediante tests chi-cuadrado
    \item \textbf{Validación cruzada estratificada:} Uso de k-fold estratificado (k=5) durante la optimización de hiperparámetros para garantizar robustez
\end{enumerate}
...
\hline
\rowcolor{UAMAzcapoMedium!30}
\textbf{Iteraciones totales} & \textbf{31 temperaturas} & \textbf{Niveles de enfriamiento desde TI hasta TF} \\
\hline
\end{tabular}
}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Modelo}} & \textbf{\textcolor{white}{Parámetros}} & \textbf{\textcolor{white}{Capas}} & \textbf{\textcolor{white}{Dimensión}} & \textbf{\textcolor{white}{Soporte Español}} & \textbf{\textcolor{white}{Reducción vs BERT}} \\
\hline
\rowcolor{UAMCuajimalpaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Componente}} & \textbf{\textcolor{white}{Especificación}} & \textbf{\textcolor{white}{Características Relevantes}} \\
\hline
\rowcolor{UAMCuajimalpaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Parámetro}} & \textbf{\textcolor{white}{Valor}} & \textbf{\textcolor{white}{Justificación}} \\
\hline
\rowcolor{UAMAzcapoLight!40}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Técnica}} & \textbf{\textcolor{white}{Rango Explorado}} & \textbf{\textcolor{white}{Valor Óptimo}} & \textbf{\textcolor{white}{Propósito}} \\
\hline
\rowcolor{UAMCuajimalpaLight!50}
...
\begin{enumerate}
    ...
    \item \textbf{Validación cruzada:} Confirmación de estabilidad con múltiples semillas aleatorias (k=5)
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Fase}} & \textbf{\textcolor{white}{Conjunto}} & \textbf{\textcolor{white}{Porcentaje}} & \textbf{\textcolor{white}{Propósito}} & \textbf{\textcolor{white}{Restricciones}} \\
\hline
\rowcolor{UAMAzcapoLight!40}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Categoría}} & \textbf{\textcolor{white}{Descripción}} & \textbf{\textcolor{white}{Interpretación en Noticias Falsas}} & \textbf{\textcolor{white}{Impacto}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\multicolumn{1}{|c|}{\textcolor{white}{\textbf{}}} & \multicolumn{2}{c|}{\textcolor{white}{\textbf{Predicción del Modelo}}} \\
\hline
\rowcolor{UAMAzcapo}
\textcolor{white}{\textbf{Realidad}} & \textcolor{white}{\textbf{REAL}} & \textcolor{white}{\textbf{FALSO}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
\textbf{REAL} & TP & FN \\
\hline
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Métrica}} & \textbf{\textcolor{white}{Fórmula}} & \textbf{\textcolor{white}{Interpretación}} & \textbf{\textcolor{white}{Relevancia en Detección}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Criterio}} & \textbf{\textcolor{white}{Peso}} & \textbf{\textcolor{white}{Métrica Principal}} & \textbf{\textcolor{white}{Métricas Secundarias}} & \textbf{\textcolor{white}{Justificación}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Componente del Reporte}} & \textbf{\textcolor{white}{Contenido}} \\
\hline
\rowcolor{UAMAzcapoLight!40}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Componente}} & \textbf{\textcolor{white}{Especificación}} & \textbf{\textcolor{white}{Ventajas para Metaheurísticos}} \\
\hline
\rowcolor{UAMCuajimalpaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Categoría}} & \textbf{\textcolor{white}{Herramienta/Librería}} & \textbf{\textcolor{white}{Versión}} & \textbf{\textcolor{white}{Propósito Específico}} \\
\hline
\rowcolor{UAMCuajimalpaLight!50}
...
\hline
\rowcolor{UAMLermaLight!50}
\textbf{Transformers} & transformers (Hugging Face) & 4.35.0 & \begin{tabular}[t]{@{}l@{}}Modelos preentrenados\\Tokenización avanzada\end{tabular} \\
\hline
\rowcolor{UAMXochimilcoLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Principio Ético}} & \textbf{\textcolor{white}{Implementación}} & \textbf{\textcolor{white}{Mecanismo de Control}} & \textbf{\textcolor{white}{Impacto Esperado}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
...
\hline
\rowcolor{UAMAzcapo}
\textbf{\textcolor{white}{Artefacto}} & \textbf{\textcolor{white}{Formato}} & \textbf{\textcolor{white}{Contenido}} & \textbf{\textcolor{white}{Disponibilidad}} \\
\hline
\rowcolor{UAMIztapalapaLight!50}
