...
\begin{center}
\Large \bf
Calibración de Hiperparámetros en Algoritmos Metaheurísticos y Modelos de Lenguaje para la Detección de Noticias Falsas
\end{center}
\vspace*{\stretch{0.5}}
...
\vspace{1.2cm}
{\large \bf Ciudad de México \hfill Noviembre 2025}